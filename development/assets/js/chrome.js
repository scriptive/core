...
chrome.app.runtime.onLaunched.addListener(function(){
    chrome.app.window.create(
        ...
        function(win) {
            ...
            var laisiangtho={
                data:{
                    'jquery.min':{type:'script',dir:'lib/'},
                    'jquery.ui.min':{type:'script',dir:'lib/'},
                    'jquery.ui.touch-punch.min':{type:'script',dir:'lib/'},
                    'chrome.google-analytics-bundle':{type:'script',dir:'lib/'},
                    'localforage.min':{type:'script',dir:'lib/'},
                    'script':{type:'script'}
                },
                script:{
                ...
                load:function(meta){
                    var x=meta.shift(), type=this.data[x].type, self=this,
                        metaURL=(this.data[x].dir?this.data[x].dir:this[type].dir)+x+this[type].extension;
                ...
                ready:function(){
                    app.jQuery(app.document.body).laisiangtho({
                      L:{script:['data bible','data config']},
